...
const Layout2 = ({ children }: Props) => {
  ...
  const navigation1 = [
    ...
    },
    {
      name: "Title",
      href: "/title",
      current: currentPath.includes("title"),
      icon: BookOpenIcon,
      count: null,
    },
  ...
  const navigation2 = [
    {
      name: "Feed",
      href: "/feed2",
      current: currentPath.includes("feed2"),
          ...
          <aside className="w-80 bg-base-200">
            ...
            <ul className="menu menu-compact flex flex-col p-0 px-4">
              ...
              {navigation2.map((item) => (
                <li key={item.name}>
                  <Link href={item.href}    className={clsx("flex gap-4", item.current && "active")}>
                    {/* <a
                      className={clsx("flex gap-4", item.current && "active")}
                    > */}
                      <span className="flex-1">{item.name}</span>
